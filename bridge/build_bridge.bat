...
pyinstaller --onefile --name outlook_bridge --paths ..\src --hidden-import win32com --hidden-import win32com.client --hidden-import pythoncom --hidden-import pywintypes --collect-submodules win32com outlook_bridge.py
if errorlevel 1 goto :fail
